    ...
    render() {
        ...
        const newarray = this.state.allStock.filter(stock => {
            return (
                stock.coralname
                    .toLowerCase()
                    .includes(this.state.searchCoral.toLowerCase()) +
                stock.categories
                    .toLowerCase()
                    .includes(this.state.searchCoral.toLowerCase())
            );
        ...
        return (
            <React.Fragment>
                ...
                <div className="flexbox">
                    {currentPost.map((currentCoral, i) => {
                        return (
                            <Stock
                                add={this.props.add}
                                oneCoral={currentCoral}
                                copyBasket={this.copyBasket.bind(this)}
                                key={i}
                            />
                        );
                    })}
                ...
                <Pagination
                    ...
                    totalPost={this.state.allStock.length}
                    paginate={paginate}
                />
            </React.Fragment>
        );
